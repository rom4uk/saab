...
import {buttonsConfig} from './elements/buttonsConfig';
import HotswapButton from './elements/HotswapButton'

const Page15 = ({handleChange}) => {
      ...
      <div className="sidebar">
        ...
        <div className="scene_toggle_menu scene_toggle_menu--hotswap">
          ...
          <div className="scene_toggle_menu__buttons">
            {buttonsConfig.map((button, i) => <HotswapButton Elem={button.icon} title={button.title} className={classes[button.classname]} handler={toggleItems} idx={i} key={i} />)}
          </div> 
